...
namespace Moni.Controllers
{
    ...
    public class RevenueController : BalanceBaseController<Revenue>
    {
        public RevenueController(MoniContext context)
        {
            Repository = new RevenueRepository(context);
        }

        public RevenueRepository Repository { get; set; }
